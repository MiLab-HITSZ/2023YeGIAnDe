...
# @File       : main_attack_mix_defense_tinyimagenet.py
...
if __name__ == '__main__':
    ...
    cfg = breaching.get_config(overrides=["case=13_custom_tinyimagenet", "attack=our_vgg13_dyna_untrain"])
    ...
    cus_data = CustomData(data_dir='custom_data/32_img/', dataset_name='TinyImageNet', case='13_custom_tinyimagenet', mix=cfg.case.data.mix, only_mix=only_mix)
